...
List<AllDoctor> allDoctorFromJson(String str) => List<AllDoctor>.from(json.decode(str).map((x) => AllDoctor.fromJson(x)));

String allDoctorToJson(List<AllDoctor> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
