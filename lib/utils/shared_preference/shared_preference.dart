...
class SharedPreference {
  ...
  static Future setUserInfo(Map<String, dynamic> info) async =>
      await _pref.setString('userInfo', jsonEncode(info));
  static Map<String, dynamic> getUserInfo() =>
      jsonDecode(_pref.getString('userInfo')!);
